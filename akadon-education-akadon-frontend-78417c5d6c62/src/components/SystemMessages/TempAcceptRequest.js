...
import Icon from "../../assets/icons/temp-accept.svg";

function TempAcceptRequest({ msg }) {
  if (!msg) return <></>;
...
TempAcceptRequest.propTypes = { msg: PropTypes.object };

export default TempAcceptRequest;
