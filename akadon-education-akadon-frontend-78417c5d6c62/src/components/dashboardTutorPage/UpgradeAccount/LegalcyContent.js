...
const LegalcyContent = ({ modal, setModal }) => {
  return (
    <Modal
      isOpen={modal}
      modalClassName="legalcy-content-modal"
      contentClassName="border-0 px-4 py-3"
    >
          ...
          <tr>
            ...
            <td colSpan={2}>
              ...
              <ul>
                ...
                <li className="ml-2">
                  Thời gian nhận LLTP:{" "}
                  <span className="text-bold2">Sau 15 ngày </span>từ ngày nộp tờ
                  khai
                </li>
              </ul>
            </td>
          ...
          <tr>
            ...
            <td colSpan={2}>
              <ul className="px-0">
                ...
                <li className="text-bold2">
                  <span className="text-hightlight">Hồ sơ</span> giống như làm
                  trực tiếp
                </li>
                <li>
                  <p>
                    <span className="text-bold2 text-hightlight">Lệ phí:</span>{" "}
                    <span className="text-bold2">
                      Ngoài 200,000 vnđ làm LLTP, còn:{" "}
                    </span>
                    <br></br>
                    Phí chuyển phát nội tỉnh 1 chiều: <br></br> 22.000 + Phí thu
                    hộ nộp hộ (13.000) ={" "}
                    <span className="text-bold2">35.000 vnđ</span> <br></br>Phí
                    chuyển phát nội tỉnh 2 chiều: <br></br>44.000 + Phí thu hộ
                    nộp hộ (13.000) =
                    <span className="text-bold2">57.000 vnđ</span> <br></br>Phí
                    chuyển phát liên tỉnh 2 chiều: <br></br>88.000 + Phí thu hộ
                    nộp hộ (13.000) ={" "}
                ...
                <li>
                  ...
                  , trừ các địa phương:
                  <span className="text-bold2">
                    Vĩnh Phúc, Tây Ninh, Hải Dương, Hưng Yên, Long An, Hà Tĩnh,
                    Cao bằng, Đắk Lắk
                  </span>
                </li>
              </ul>
          ...
          <tr>
            ...
            <td colSpan={2}>
              <ul>
                ...
                <li>
                  Sau khi hoàn tất, Đối tác sẽ nhận được mã số trực tuyến. Mang
                  mã số này đến Sở tư pháp để được nộp hồ sơ + lệ phí nhanh
                  chóng
                </li>
                <li>
                  Nhờ người thân (cha, mẹ, vợ, chồng, con) mang hồ sơ đến sở tư
                  pháp nơi cư trú, cung cấp mã số trực tuyến và nộp hồ sơ + lệ
                  phí
                </li>
                <li>
...
LegalcyContent.propTypes = {
  modal: PropTypes.bool,
  setModal: PropTypes.func,
}
export default LegalcyContent;
